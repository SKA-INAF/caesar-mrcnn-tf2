...
## **Pre-trained models**  
We have trained the Mask-RCNN TF2 model from scratch on the same annotated radio dataset that was previously used to train Mask R-CNN TF1 model in paper Riggi+2023 (see Credits for full reference). 
